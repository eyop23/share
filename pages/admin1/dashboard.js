          ...
          <div className="bg-white border border-gray-200 rounded-lg p-4 shadow">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="flex items-center p-4 rounded-lg hover:bg-gray-50 transition-colors duration-300 ease-in-out">
                <Link href="https://share-mangement-sym.vercel.app/admin1/shareholder_list">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    maintains a registry of all shareholders, including their
                    personal information and share ownership information
                  </p>
                </div>
              </div>
              <div className="flex items-center p-4 rounded-lg hover:bg-gray-50 transition-colors duration-300 ease-in-out">
                <Link href="https://share-mangement-sym.vercel.app/admin1/news">
              ...
              <div className="flex items-center p-4 rounded-lg hover:bg-gray-100 transition-colors duration-300 ease-in-out">
                <Link href="https://share-mangement-sym.vercel.app/admin1/report">
              ...
              <div className="flex items-center p-4 rounded-lg hover:bg-gray-50 transition-colors duration-300 ease-in-out">
                <Link href="https://share-mangement-sym.vercel.app/admin1/newBuyersList">
              ...
              <div className="flex items-center p-4 rounded-lg hover:bg-gray-50 transition-colors duration-300 ease-in-out">
                <Link href="https://share-mangement-sym.vercel.app/admin1/chat">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Start a chat with an shareholders to receive any queastion
                    and answer.
                  </p>
                </div>
              </div>
              <div className="flex items-center p-4 rounded-lg hover:bg-gray-50 transition-colors duration-300 ease-in-out">
                <Link href="https://share-mangement-sym.vercel.app/admin1/settings">
